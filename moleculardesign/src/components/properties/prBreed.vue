<template>
  <div>
    <div id="main">
      <el-checkbox-group v-model="prBreed">
        <div id="left" ></div>

        <div id="center" style="display: flex; flex-wrap: wrap;">
          <div class="PrBreedDiv" style="width: 100%;">
...
export default {
  ...
  methods: {
    handleSubmit() {
      ...
      if (this.prBreed.length>0){
        axios.post(`${this.$API_BASE_URL}/prBreed/selectBreed`, {
          prBreed: this.prBreed,
        },{
          headers: {
